...
### Initial Vietnamese Text-to-Speech Model
This experiment was conducted using the [`infore1_25h`](https://huggingface.co/datasets/doof-ferb/infore1_25hours) dataset on a system equipped with 2 x 4090 GPUs. Key training parameters were:
- Batch Size: 20
- Epochs: 1600 (approximately 70,000 steps)
- The total training time was approximately 15 hours.
...
- **Sample 1**: Đây là mô hình tổng hợp giọng nói tiếng Việt, được nghiên cứu và phát triển bởi VinAI  
    <audio controls>
        ...
        The browser does not support the audio element. Please go to [sample 1](https://drive.google.com/file/d/1aemp9uJKlx53kHK5JogF8FUlP7nSwDKD/view?usp=drive_link)
    </audio>
...
- **Sample 2**: Xin chào, mình là Cường. Mình năm nay 23 tuổi. Mình đang sống ở Hà Nội. Mình rất vui khi được gặp bạn  
    <audio controls>
        ...
        The browser does not support the audio element. Please go to [sample 2](https://drive.google.com/file/d/1thrLf-aGAjJi92zgz64-tzdpyOkV0uBK/view?usp=drive_link)
    </audio>
...
- **Sample 3**: Lê Quý Đôn, tên thuở nhỏ là Lê Danh Phương, là vị quan thời Lê trung hưng, cũng là nhà thơ và được mệnh danh là nhà bác học lớn của Việt Nam trong thời phong kiến  
    <audio controls>
        ...
        The browser does not support the audio element. Please go to [sample 3](https://drive.google.com/file/d/1Mj7O8OKxXXz0SW3gdH3k8QGp1iTAUuO8/view?usp=drive_link)
    </audio>
...
- **Sample 4**: Hiện nay, vị trí của bàn thờ thường được đặt trong phòng riêng ở tầng trên cùng của nhà  
    <audio controls>
        ...
        The browser does not support the audio element. Please go to [sample 4](https://drive.google.com/file/d/1YJ8SiHteRWYd4p6gBgUwBaO79ajRW9PP/view?usp=drive_link)
    </audio>
...
### Subsequent Experiment: Bilingual Training (Vietnamese + English)

A follow-up experiment involved training on data generated using the OpenAI API (via [openai.fm](https://www.openai.fm/)) featuring the 'alloy' voice. (Note: Data generation cost approximately $20 and is used solely for research purposes. Acknowledgements to OpenAI)
...
**Generated Audio Samples**. Audio samples from this bilingual training experiment are presented below:

- **Sample 1**: Hôm_nay , weather thật là beautiful , rất thích hợp để đi picnic ở công_viên. [Generated Audio Here](https://drive.google.com/file/d/1A7hzW-1KvAOZJZuG59Qe_GRlxbCwNPQh/view?usp=drive_link)
- **Sample 2**: Hôm_nay phòng_họp paris và madrid còn trống , đội marketing và technical writer có thể đặt phòng_họp này để họp . [Generated Audio Here](https://drive.google.com/file/d/1Du3Ik98Lm5i30s5YPShZgndbfIORQNPf/view?usp=drive_link)
- **Sample 3**: Hàng tháng , chúng_tôi sẽ generate báo_cáo lợi_nhuận và lỗ để đánh_giá performance của công ty . [Generated Audio Here](https://drive.google.com/file/d/1PFYuHnDJNlVM5F0g6YqX4_MH7CkPmguX/view?usp=drive_link)
- **Sample 4**: Nhóm kế_toán sẽ kiểm_tra các khoản payable và receivable để đảm_bảo accuracy trong financial statements . [Generated Audio Here](https://drive.google.com/file/d/17SCCR566d6ShaUbuqu4z4xFNULf3XFNw/view?usp=drive_link)

> [!NOTE]
> Notes on generating data using OpenAI:
> - Audio files often have extra silence automatically added at the end. For example, some utterances that were actually 5 seconds long were generated with durations up to 62 seconds.
> - The same sentence is sometimes repeated multiple times within the output.
> - After finishing the designated sentence, the model sometimes utters and repeats unrelated content or gibberish (not present in the original input text).
> - Frequently misreads the beginning of words.
